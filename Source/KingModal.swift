...
//  KingModal
//
//  Created by Jiajun Zheng on 15/5/15.
...
//MARK: - 以下为工具类和方法
//MARK: - 转场动画代理
public class PopoverAnimator: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate {
...
//MARK: - 转场动画展现控制器
public class PopoverPresentationController: UIPresentationController {
    /// 展现位置
    var presentedFrame: CGRect = CGRectZero
